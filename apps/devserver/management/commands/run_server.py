...
from apps.devserver.handlers import DevServerHandler
from apps.devserver.utils.http import SlimWSGIRequestHandler
...
class Command(BaseCommand):
	...
	def inner_run(self, *args, **options):
		...
		from apps.devserver import settings
		import apps.devserver
		...
		self.stdout.write((
			                  ...
			                  "devserver_version": apps.devserver.get_version(),
