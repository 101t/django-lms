...
class CacheSummaryModule(DevServerModule):
	...
	def process_init(self, request):
		from apps.devserver.utils.stats import track
	...
	def process_complete(self, request):
		...
		misses = stats.get_total_misses_for_function('cache', cache.get) + \
				stats.get_total_misses_for_function('cache', cache.get_many)
